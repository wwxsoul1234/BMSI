...
def get_filter_disparity(num,blockSize,imgL, imgR, use_wls=True, sgbm="param1"):
    """
    进行立体匹配，计算视差图
...
def get_visual_depth(depth, clip_max=60000):
    """
    将输入深度图转换为伪彩色图，方面可视化
...
def get_visual_disparity(disp, clip_max=60000):
    """
